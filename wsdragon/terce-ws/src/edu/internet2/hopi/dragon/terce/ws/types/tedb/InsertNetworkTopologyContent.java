/**
 * InsertNetworkTopologyContent.java
 *
...
/**
 * InsertNetworkTopologyContent bean class
 */
public class InsertNetworkTopologyContent implements org.apache.axis2.databinding.ADBBean {
    /** field for Database */
    ...
    public void setTopology(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneTopologyContent param) {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    InsertNetworkTopologyContent.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTopology.serialize(new javax.xml.namespace.QName(
                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                "topology"), factory, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localDatabaseTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://hopi.internet2.edu/DRAGON/TERCE/TEDB", "database"));
    ...
    public static class Factory {
         ...
         */
        public static InsertNetworkTopologyContent parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            InsertNetworkTopologyContent object = new InsertNetworkTopologyContent();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"insertNetworkTopologyContent".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (InsertNetworkTopologyContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setDatabase(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "topology").equals(reader.getName())) {
                    object.setTopology(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneTopologyContent.Factory.parse(
                            reader));

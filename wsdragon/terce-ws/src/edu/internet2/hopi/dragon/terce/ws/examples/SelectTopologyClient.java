    ...
    public static void main(String[] args) {
        try {
            ...
            if ((args.length == 1) || (args.length == 2)) {
                ...
                System.out.println(
                    "Must provide TERCE URL as argument (and optionaly the database)");
                System.exit(0);
            }
            ...
            CtrlPlaneDomainContent[] domains = response.getSelectNetworkTopologyResponse()
                                                       .getTopology().getDomain();

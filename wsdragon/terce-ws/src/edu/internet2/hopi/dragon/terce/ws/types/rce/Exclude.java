 ...
 * Exclude bean class
 */
public class Exclude implements org.apache.axis2.databinding.ADBBean {
    /** field for Layer This was an Attribute! */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Exclude.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localLayer != null) {
            writeAttribute("", "layer",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localLayer), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "layer"));
    ...
    public static class Factory {
         ...
         */
        public static Exclude parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"exclude".equals(type)) {
                            ...
                            return (Exclude) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribLayer = reader.getAttributeValue(null,
                        "layer");

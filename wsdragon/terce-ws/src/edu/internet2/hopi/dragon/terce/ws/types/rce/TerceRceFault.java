...
/**
 * TerceRceFault bean class
 */
public class TerceRceFault implements org.apache.axis2.databinding.ADBBean {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    TerceRceFault.this.serialize(MY_QNAME, factory, xmlWriter);
                }
            };
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://hopi.internet2.edu/DRAGON/TERCE/RCE", "msg"));
    ...
    public static class Factory {
         ...
         */
        public static TerceRceFault parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TerceRceFault object = new TerceRceFault();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TerceRceFault".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TerceRceFault) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://hopi.internet2.edu/DRAGON/TERCE/RCE", "msg").equals(
                            reader.getName())) {

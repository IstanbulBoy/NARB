...
/**
 * FindPathResponseContent bean class
 */
public class FindPathResponseContent implements org.apache.axis2.databinding.ADBBean {
    /** field for Path */
     ...
     */
    public void setPath(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePathContent param) {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    FindPathResponseContent.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localPath.serialize(new javax.xml.namespace.QName(
                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                "path"), factory, xmlWriter);
        ...
        if (localAvailableVtagsTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "availableVtags",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
    ...
    public static class Factory {
         ...
         */
        public static FindPathResponseContent parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"findPathResponseContent".equals(type)) {
                            ...
                            return (FindPathResponseContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setPath(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePathContent.Factory.parse(
                                    reader));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://hopi.internet2.edu/DRAGON/TERCE/RCE",
                                    "availableVtags").equals(reader.getName())) {
                            java.lang.String content = reader.getElementText();

                            object.setAvailableVtags(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));

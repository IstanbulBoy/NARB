 ...
 */
public class CtrlPlaneTopologyContent implements org.apache.axis2.databinding.ADBBean {
    /** field for IdcId */
    protected java.lang.String localIdcId;

    /** field for Domain This was an Array! */
    ...
    /** field for DomainSignature This was an Array! */
    ...
    protected void validateDomain(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent[] param) {
    }
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent
     */
    public void addDomain(
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDomain);
        list.add(param);
        this.localDomain = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent[list.size()]);
    }
     ...
     */
    protected void validateDomainSignature(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent[] param) {
    }
     ...
     */
    public void setDomainSignature(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent[] param) {
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent
     */
    public void addDomainSignature(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDomainSignature);
        list.add(param);
        this.localDomainSignature = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    CtrlPlaneTopologyContent.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
            ...
            if (localDomain != null) {
                for (int i = 0; i < localDomain.length; i++) {
                    if (localDomain[i] != null) {
                        localDomain[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "domain"), factory, xmlWriter);
                    } else {
            ...
            if (localDomainSignature != null) {
                for (int i = 0; i < localDomainSignature.length; i++) {
                    if (localDomainSignature[i] != null) {
                        localDomainSignature[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "domainSignature"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "domainSignature cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CtrlPlaneTopologyContent parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CtrlPlaneTopologyContent".equals(type)) {
                            ...
                            return (CtrlPlaneTopologyContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "idcId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setIdcId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    list2.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent.Factory.parse(
                            reader));
                    ...
                    object.setDomain((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "domainSignature").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list3.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setDomainSignature((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneDomainSignatureContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(

 ...
 */
public class CtrlPlanePathContent implements org.apache.axis2.databinding.ADBBean {
    /** field for Hop This was an Array! */
     ...
     */
    protected void validateHop(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent[] param) {
    }
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent
     */
    public void addHop(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent param) {
        if (localHop == null) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localHop);
        list.add(param);
        this.localHop = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    CtrlPlanePathContent.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
        ...
        if (localHopTracker) {
            if (localHop != null) {
                for (int i = 0; i < localHop.length; i++) {
                    if (localHop[i] != null) {
                        localHop[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "hop"), factory, xmlWriter);
                    } else {
    ...
    public static class Factory {
         ...
         */
        public static CtrlPlanePathContent parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CtrlPlanePathContent".equals(type)) {
                            ...
                            return (CtrlPlanePathContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "hop").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list1.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent.Factory.parse(
                            reader));
                    ...
                    object.setHop((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneHopContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(

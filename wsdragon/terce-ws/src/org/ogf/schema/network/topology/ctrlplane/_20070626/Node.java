 ...
 * Node bean class
 */
public class Node implements org.apache.axis2.databinding.ADBBean {
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setNode(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent.Factory.parse(
                                    reader));

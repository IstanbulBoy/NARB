 ...
 */
public class CtrlPlaneLinkContent implements org.apache.axis2.databinding.ADBBean {
    ...
    protected java.lang.String localRemotePortId;
    ...
    protected java.lang.String localRemoteNodeId;
    ...
    protected java.lang.String localRemoteDomainId;
    ...
    /** field for LinkProtectionTypes This was an Array! */
    ...
    /** field for AdministrativeGroups This was an Array! */
     ...
     * @return java.lang.String
     */
    public java.lang.String getRemotePortId() {
     ...
     */
    public void setRemotePortId(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
     ...
     */
    public void setRemoteNodeId(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
     ...
     * @return java.lang.String
     */
    public java.lang.String getRemoteDomainId() {
     ...
     */
    public void setRemoteDomainId(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
    ...
    public void addLinkProtectionTypes(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localLinkProtectionTypes);
        list.add(param);
        this.localLinkProtectionTypes = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
     ...
     */
    protected void validateAdministrativeGroups(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup[] param) {
    }
     ...
     */
    public void setAdministrativeGroups(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup[] param) {
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup
     */
    public void addAdministrativeGroups(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localAdministrativeGroups);
        list.add(param);
        this.localAdministrativeGroups = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup[list.size()]);
    }
     ...
     */
    public void setSwitchingCapabilityDescriptors(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneSwcapContent param) {
        if (param != null) {
            //update the setting tracker
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    CtrlPlaneLinkContent.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localRemoteLinkIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "remoteLinkId",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
        ...
        if (localRemotePortIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "remotePortId",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "remotePortId");
                }
            } else {
                xmlWriter.writeStartElement("remotePortId");
            }

            if (localRemotePortId == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "remotePortId cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRemotePortId);
            }
        ...
        if (localRemoteNodeIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "remoteNodeId",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "remoteNodeId");
                }
            } else {
                xmlWriter.writeStartElement("remoteNodeId");
            }

            if (localRemoteNodeId == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "remoteNodeId cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRemoteNodeId);
            }
        ...
        if (localRemoteDomainIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "remoteDomainId",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "remoteDomainId");
                }
            } else {
                xmlWriter.writeStartElement("remoteDomainId");
            }

            if (localRemoteDomainId == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "remoteDomainId cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRemoteDomainId);
            }
        ...
        if (localTrafficEngineeringMetricTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix,
                        "trafficEngineeringMetric", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace,
            ...
            if (localTrafficEngineeringMetric == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "trafficEngineeringMetric cannot be null!!");
            } else {
        ...
        if (localLinkProtectionTypesTracker) {
            if (localLinkProtectionTypes != null) {
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "linkProtectionTypes cannot be null!!");
            }
        }
        ...
        if (localMaximumReservableCapacityTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix,
                        "maximumReservableCapacity", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace,
            ...
            if (localMaximumReservableCapacity == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "maximumReservableCapacity cannot be null!!");
            } else {
        ...
        if (localMinimumReservableCapacityTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix,
                        "minimumReservableCapacity", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace,
            ...
            if (localMinimumReservableCapacity == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "minimumReservableCapacity cannot be null!!");
            } else {
        ...
        if (localUnreservedCapacityTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "unreservedCapacity",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
            ...
            if (localUnreservedCapacity == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "unreservedCapacity cannot be null!!");
            } else {
            ...
            if (localAdministrativeGroups != null) {
                for (int i = 0; i < localAdministrativeGroups.length; i++) {
                    if (localAdministrativeGroups[i] != null) {
                        localAdministrativeGroups[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "administrativeGroups"), factory, xmlWriter);
                    } else {
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "administrativeGroups cannot be null!!");
            }
        }
        ...
        if (localSwitchingCapabilityDescriptorsTracker) {
            if (localSwitchingCapabilityDescriptors == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SwitchingCapabilityDescriptors cannot be null!!");
            }

            localSwitchingCapabilityDescriptors.serialize(new javax.xml.namespace.QName(
                    "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                    "SwitchingCapabilityDescriptors"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localMaximumReservableCapacityTracker) {
            ...
            if (localMaximumReservableCapacity != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localMaximumReservableCapacity));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                    "maximumReservableCapacity cannot be null!!");
            }
        ...
        if (localMinimumReservableCapacityTracker) {
            ...
            if (localMinimumReservableCapacity != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localMinimumReservableCapacity));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                    "minimumReservableCapacity cannot be null!!");
            }
    ...
    public static class Factory {
         ...
         */
        public static CtrlPlaneLinkContent parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CtrlPlaneLinkContent".equals(type)) {
                            ...
                            return (CtrlPlaneLinkContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "remoteLinkId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setRemoteLinkId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "remotePortId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setRemotePortId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "remoteNodeId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setRemoteNodeId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "remoteDomainId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setRemoteDomainId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "trafficEngineeringMetric").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setTrafficEngineeringMetric(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "linkProtectionTypes").equals(reader.getName())) {
                    ...
                    object.setLinkProtectionTypes((java.lang.String[]) list6.toArray(
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "capacity").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setCapacity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "maximumReservableCapacity").equals(
                            reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setMaximumReservableCapacity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "minimumReservableCapacity").equals(
                            reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setMinimumReservableCapacity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "granularity").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setGranularity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "unreservedCapacity").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setUnreservedCapacity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "administrativeGroups").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list12.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setAdministrativeGroups((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneAdministrativeGroup[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                            "SwitchingCapabilityDescriptors").equals(
                            reader.getName())) {
                    object.setSwitchingCapabilityDescriptors(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneSwcapContent.Factory.parse(
                            reader));

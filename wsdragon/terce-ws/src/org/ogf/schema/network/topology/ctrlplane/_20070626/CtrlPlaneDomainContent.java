 ...
 */
public class CtrlPlaneDomainContent implements org.apache.axis2.databinding.ADBBean {
    ...
    protected void validateNode(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent[] param) {
    }
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent
     */
    public void addNode(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent param) {
        if (localNode == null) {
        ...
        list.add(param);
        this.localNode = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent[list.size()]);
    }
    ...
    protected void validatePort(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent[] param) {
    }
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent
     */
    public void addPort(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent param) {
        if (localPort == null) {
        ...
        list.add(param);
        this.localPort = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent[list.size()]);
    }
    ...
    protected void validateLink(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent[] param) {
    }
     ...
     *
     * @param param
     *        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent
     */
    public void addLink(
        org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent param) {
        if (localLink == null) {
        ...
        list.add(param);
        this.localLink = (org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent[]) list.toArray(new org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    CtrlPlaneDomainContent.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
        ...
        if (localNodeTracker) {
            if (localNode != null) {
                for (int i = 0; i < localNode.length; i++) {
                    if (localNode[i] != null) {
                        localNode[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "node"), factory, xmlWriter);
                    } else {
        ...
        if (localPortTracker) {
            if (localPort != null) {
                for (int i = 0; i < localPort.length; i++) {
                    if (localPort[i] != null) {
                        localPort[i].serialize(new javax.xml.namespace.QName(
                                "http://ogf.org/schema/network/topology/ctrlPlane/20070626/",
                                "port"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static CtrlPlaneDomainContent parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CtrlPlaneDomainContent".equals(type)) {
                            ...
                            return (CtrlPlaneDomainContent) edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    list1.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent.Factory.parse(
                            reader));
                    ...
                    object.setNode((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneNodeContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list2.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setPort((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list3.add(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setLink((org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlaneLinkContent[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(

...
public class Port implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Port parse(javax.xml.stream.XMLStreamReader reader)
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setPort(org.ogf.schema.network.topology.ctrlplane._20070626.CtrlPlanePortContent.Factory.parse(
                                    reader));

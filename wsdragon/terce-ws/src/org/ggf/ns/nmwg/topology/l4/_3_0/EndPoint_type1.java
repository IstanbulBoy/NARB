            ...
            */
            ...
            /**
            *  EndPoint_type1 bean class
            */
        

        public  class EndPoint_type1
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localRoleTracker = false;
                        ...
                        */
                            ...
                            protected org.ggf.ns.nmwg.topology.l4._3_0.Role_type0 localRole ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.ggf.ns.nmwg.topology.l4._3_0.Role_type0
                           */
                           public  org.ggf.ns.nmwg.topology.l4._3_0.Role_type0 getRole(){
                               return localRole;
                           }
                            ...
                            /**
                               ...
                               * @param param Role
                               */
                               public void setRole(org.ggf.ns.nmwg.topology.l4._3_0.Role_type0 param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement(
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       EndPoint_type1.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
    ...
    public static class Factory{
        ...
        */
        public static EndPoint_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EndPoint_type1 object = new EndPoint_type1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"endPoint_type1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EndPoint_type1)edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribrole!=null){
                         java.lang.String content = tempAttribrole;
                                                ...
                                                if (tempAttribrole.indexOf(":") > 0) {
                                                    ...
                                                    object.setRole(
                                                        org.ggf.ns.nmwg.topology.l4._3_0.Role_type0.Factory.fromString(tempAttribrole,namespaceuri));
                                                } else {
                                                    // this seems to be not a qname send and empty namespace incase of it is
                                                    // check is done in fromString method
                                                    object.setRole(
                                                        org.ggf.ns.nmwg.topology.l4._3_0.Role_type0.Factory.fromString(tempAttribrole,""));
                                                }

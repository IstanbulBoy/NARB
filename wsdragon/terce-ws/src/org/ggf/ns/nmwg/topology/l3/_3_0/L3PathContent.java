            ...
            */
            ...
            /**
            *  L3PathContent bean class
            */
        

        public  class L3PathContent
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localPathIdRefTracker = false;
                        ...
                        */
                            ...
                            protected org.ggf.ns.nmwg.topology.l3._3_0.L3LinkContent localLink0 ;
                        
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localLink0Tracker = false ;
                           ...
                           */
                           public  org.ggf.ns.nmwg.topology.l3._3_0.L3LinkContent getLink0(){
                               return localLink0;
                           }
                            ...
                            /**
                               ...
                               * @param param Link0
                               */
                               public void setLink0(org.ggf.ns.nmwg.topology.l3._3_0.L3LinkContent param){
                            
                                clearAllSettingTrackers();
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localLink0Tracker = true;
                                       } else {
                                          localLink0Tracker = false;
                                              
                                       }
                                   
                                            this.localLink0=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement(
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       L3PathContent.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                if (namespace != null) {
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                                   ...
                                   localLink.serialize(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l2/3.0/","link"),
                                       factory,xmlWriter);
                                } if (localLink0Tracker){
                                    if (localLink0==null){
                                         throw new RuntimeException("link cannot be null!!");
                                    }
                                   localLink0.serialize(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","link"),
                                       factory,xmlWriter);
                                }
    ...
    public static class Factory{
        ...
        */
        public static L3PathContent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            L3PathContent object = new L3PathContent();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"L3PathContent".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (L3PathContent)edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","link").equals(reader.getName())){
                                        ...
                                        object.setLink0(org.ggf.ns.nmwg.topology.l3._3_0.L3LinkContent.Factory.parse(reader));

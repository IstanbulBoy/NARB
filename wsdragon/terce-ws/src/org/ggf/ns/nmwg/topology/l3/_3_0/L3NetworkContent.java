            ...
            */
            ...
            /**
            *  L3NetworkContent bean class
            */
        

        public  class L3NetworkContent
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = L3NetworkContent
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localSubnetTracker = false;
                
                   localNetmaskTracker = false;
                
                   localAsnTracker = false;
                   ...
                   localNetworkIdRefTracker = false;
                        ...
                        */
                            ...
                            protected org.ggf.ns.nmwg.topology.l3._3_0.Name_type4 localName ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.ggf.ns.nmwg.topology.l3._3_0.Name_type4
                           */
                           public  org.ggf.ns.nmwg.topology.l3._3_0.Name_type4 getName(){
                               return localName;
                           }
                            ...
                            /**
                               ...
                               * @param param Name
                               */
                               public void setName(org.ggf.ns.nmwg.topology.l3._3_0.Name_type4 param){
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSubnetTracker = false ;
                        ...
                        */
                            ...
                            protected java.lang.String localAsn ;
                        
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAsnTracker = false ;
                           ...
                           */
                           public  java.lang.String getAsn(){
                            ...
                            /**
                               ...
                               * @param param Asn
                               */
                               public void setAsn(java.lang.String param){
                            
                                clearAllSettingTrackers();
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAsnTracker = true;
                                       } else {
                                          localAsnTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement(
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       L3NetworkContent.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
                ...
                if (namespace != null) {
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                                   ...
                                   localName.serialize(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","name"),
                                       factory,xmlWriter);
                                } if (localTypeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"subnet", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"subnet");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("subnet");
                                          ...
                                          if (localSubnet==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new RuntimeException("subnet cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localSubnet);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"asn", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"asn");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("asn");
                                          ...
                                          if (localAsn==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new RuntimeException("asn cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localAsn);
                 ...
                 if (localNameTracker){
                            elementList.add(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/",
                             ...
                             elementList.add(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/",
                                        ...
                                        if (localSubnet != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSubnet));
                                        } else {
                                           throw new RuntimeException("subnet cannot be null!!");
                                        }
                                    } if (localNetmaskTracker){
                             ...
                             elementList.add(new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/",
                                        ...
                                        if (localAsn != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAsn));
                                        } else {
                                           throw new RuntimeException("asn cannot be null!!");
                                        }
                                    } if (localNodeTracker){
    ...
    public static class Factory{
        ...
        */
        public static L3NetworkContent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            L3NetworkContent object = new L3NetworkContent();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"L3NetworkContent".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (L3NetworkContent)edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","name").equals(reader.getName())){
                                
                                        object.setName(org.ggf.ns.nmwg.topology.l3._3_0.Name_type4.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","subnet").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ggf.org/ns/nmwg/topology/l3/3.0/","asn").equals(reader.getName())){

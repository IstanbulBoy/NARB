            ...
            */
            ...
            /**
            *  EndPoint_type3 bean class
            */
        

        public  class EndPoint_type3
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localRoleTracker = false;
                        ...
                        */
                            ...
                            protected org.ggf.ns.nmwg.topology.l4._3_0.Role_type2 localRole ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.ggf.ns.nmwg.topology.l4._3_0.Role_type2
                           */
                           public  org.ggf.ns.nmwg.topology.l4._3_0.Role_type2 getRole(){
                               return localRole;
                           }
                            ...
                            /**
                               ...
                               * @param param Role
                               */
                               public void setRole(org.ggf.ns.nmwg.topology.l4._3_0.Role_type2 param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement(
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       EndPoint_type3.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
    ...
    public static class Factory{
        ...
        */
        public static EndPoint_type3 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EndPoint_type3 object = new EndPoint_type3();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"endPoint_type3".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EndPoint_type3)edu.internet2.hopi.dragon.terce.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribrole!=null){
                         java.lang.String content = tempAttribrole;
                                                ...
                                                if (tempAttribrole.indexOf(":") > 0) {
                                                    // this seems to be a Qname so find the namespace and send
                                                    prefix = tempAttribrole.substring(0, tempAttribrole.indexOf(":"));
                                                    namespaceuri = reader.getNamespaceURI(prefix);
                                                    object.setRole(
                                                        org.ggf.ns.nmwg.topology.l4._3_0.Role_type2.Factory.fromString(tempAttribrole,namespaceuri));
                                                } else {
                                                    // this seems to be not a qname send and empty namespace incase of it is
                                                    // check is done in fromString method
                                                    object.setRole(
                                                        org.ggf.ns.nmwg.topology.l4._3_0.Role_type2.Factory.fromString(tempAttribrole,""));
                                                }

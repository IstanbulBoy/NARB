...
public class DCFaultMessageException extends java.lang.Exception{
    ...
    private edu.internet2.hopi.dragon.dc.ws.DCFault faultMessage;
    ...
    public void setFaultMessage(edu.internet2.hopi.dragon.dc.ws.DCFault msg){
       faultMessage = msg;
    }
    
    public edu.internet2.hopi.dragon.dc.ws.DCFault getFaultMessage(){
       return faultMessage;
    }
}

...
import edu.internet2.hopi.dragon.dc.DCWSClient;
...
public class DCWSClientTest {
	public static void main(String[] args){
		...
		if(args.length < 1){
			System.out.println("Usage: DCWSClientTest http://my-dc-ws-server:8080/axis2/services/DC");
			System.exit(0);
		}
		...
		try{
			...
			DCWSClient client = new DCWSClient(args[0]);
			...
			DCStub.Hop[] path = response.getPath().getHops().getHop();

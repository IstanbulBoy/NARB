...
public:
    PCEN_KSP(in_addr src, in_addr dest, u_int8_t sw_type, u_int8_t enc_type, float bw, u_int32_t opts, u_int32_t lspq_id, u_int32_t msg_seqnum):
        PCEN(src, dest, sw_type, enc_type, bw, opts, lspq_id,  msg_seqnum) {}
    ~PCEN_KSP();
